...
myAction tempname temph = do -- Start by displaying a greeting on the terminal
...
withTempFile pattern func = do -- The library ref says that getTemporaryDirectory may raise on
